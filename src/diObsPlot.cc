...
{
  const int auto2man[100] = { /*100-199*/ 0, 1, 2, 3, 5, 5, 0, 0, 0, 0, 10, 76, 13, 0, 0, 0,
      0, 0, 18, 0, 45, 63, 20, 63, 73, 56, 29, 38, 38, 39, 45, 41, 43, 45, 47,
      49, 0, 0, 0, 0, 63, 63, 65, 63, 65, 73, 75, 66, 67, 0, 53, 51, 53, 55, 56,
      57, 57, 58, 59, 0, 63, 61, 63, 65, 66, 67, 68, 69, 0, 73, 71, 73, 75,
      79, 79, 79, 0, 0, 0, 81, 80, 81, 81, 82, 85, 86, 86, 0, 0, 17, 17, 95, 96,
      17, 97, 99, 0, 0, 19};
